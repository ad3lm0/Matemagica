 ...
 *
 * rpg_core.js
 * Sprite.prototype.updateTransform â€“ no longer needs rounding down.
 * Tilemap.prototype.update â€“ animation frame removed
 * Tilemap.prototype.refresh â€“ repaint flag removed
 * Tilemap.prototype.updateTransform â€“ removed a lot of animation checks
 * Tilemap.prototype._paintTiles â€“ animation frame check moved to here
 * Tilemap.prototype._drawAutotile â€“ fixed error with variable names
 *
 * rpg_managers.js
 * 
 * DataManager.saveGame â€“ no longer corrupts save file while saving during a 
 * parallel process
 * StorageManager.backup â€“ new function added
 * StorageManager.backupExists â€“ new function added
 * StorageManager.cleanBackup â€“ new function added
 * StorageManager.restoreBackup â€“ new function added
 * StorageManager.loadFromLocalBackupFile â€“ new function added
 * StorageManager.loadFromWebStorageBackup â€“ new function added
 * StorageManager.webStorageBackupExists â€“ new function added
 * SceneManager â€“ added FPS synch
 * SceneManager.updateMain â€“ added in FPS synch
 * BattleManager.processEscape â€“ removed battle state removal process from
 * wrong spot
 * BattleManager.processAbort â€“ inserted battle state removal process to
 * correct timing
 * 
 * rpg_objects.js
 * Game_Action.prototype.decideRandomTarget â€“ random target index bug fixed
 * Game_Action.prototype.evaluate â€“ target index bug fixed
 * Game_Action.prototype.evalDamageFormula â€“ if formulas are used that return
 * NaN, return 0 instead
 * Game_Actor.prototype.changeClass â€“ exp bug fixed
 * Game_Event.prototype.updateSelfMovement â€“ added extra check to see if the
 * event is not locked
 * Game_Interpreter.prototype.command321 â€“ class change command now has the
 * option to keep exp across changing classes
 * 
 * rpg_scenes.js
 * Scene_Save.prototype.onSaveSuccess â€“ backup process functionality added
 *
 * rpg_sprites.js
 * Sprite_Actor.prototype.refreshMotion â€“ added a fix for guard motion
 * Spriteset_Map.prototype._canvasReAddParallax â€“ new function added
 * Spriteset_Map.prototype.updateParallax â€“ implemented fix for parallax bug
 *
 * rpg_windows.js
 * Window_MenuStatus.prototype.drawItemImage â€“ fixed bug involving variable
 * face dimensions
 * Window_ActorCommand.prototype.selectLast â€“ fixed bug with saved last
 * selected command
 *
 * ============================================================================
 ...
 * Tilemapâ€™s TileRenderer mode will automatically default to Nearest Neighbor
 ...
 * 
 * rpg_scenes.js
 * No changes (good, since it doesnâ€™t have the Scene_Item active window breaker)
 * 
 * rpg_sprites.js
